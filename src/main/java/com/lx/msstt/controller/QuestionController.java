...
import com.lx.msstt.model.dto.question.*;
...
public class QuestionController {
     ...
     */
    @GetMapping("/get/vo")
    @CrawlerCheck(timeInterval = 1, timeUnit = TimeUnit.MINUTES, expirationTimeInSeconds = 180)
...
//        crawlerDetect(loginUser.getId());
     ...
     * @param longUserId
     */
//    private void crawlerDetect(long longUserId) {
//        // 调用多少次时告警
...
//    }
    ...
    public BaseResponse<Boolean> editQuestion(@RequestBody QuestionEditRequest questionEditRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(questionEditRequest.getId() <= 0, ErrorCode.PARAMS_ERROR);
