...
import com.lx.msstt.model.dto.questionbankquestion.*;
...
public class QuestionBankQuestionController {
    ...
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> batchRemoveQuestionToBank(@RequestBody QuestionBankQuestionBatchRemoveRequest questionBankQuestionBatchRemoveRequest,
        HttpServletRequest request
    ) {
